...
public class ProvideFeedBackController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        // Adjust path to not include the leading slash if resources are in src/main/resources
        URL onImageUrl = getClass().getResource("images/star.png");
        URL offImageUrl = getClass().getResource("images/star-off.png");
